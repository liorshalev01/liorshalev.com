...
## Jan 2026 – Present: Freelance

Freelance software engineer focused on production reliability, low-level systems, and cross-platform performance.
...
Talon's Enterprise Browser, a Chromium-based secure browser.
...
_C++20, TypeScript, Python, and Chromium internals._

## Dec 2019 – Dec 2022: D-Fend Solutions (acquired by Motorola Solutions)

### Senior Software Developer

Counter-drone RF and Wi-Fi cybersecurity systems, deployed globally by defense and critical-infrastructure customers.
...
_Python, C, C++, and Linux._

## Jan 2018 – Dec 2019: TechSee

### Senior Software Developer

Augmented reality customer support platform combining AI computer vision with WebRTC.
