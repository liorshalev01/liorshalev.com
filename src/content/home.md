...
- **Security startup, founding team (2025).** Principal architect/developer. Designed and built a system where even a fully compromised computer cannot read the user's screen or keyboard: display and input run on separate trusted hardware, and the computer in between carries only encrypted data. Delivered a working prototype and a provisional patent on the key-exchange protocol.

- **Talon Cyber Security (2023–2024).** Built data-loss-prevention and security-hardening features inside Talon's Chromium-based enterprise browser. Acquired by Palo Alto Networks.
- **D-Fend Solutions (2019–2022).** Software architect and team lead for the Wi-Fi counter-drone system, deployed by defense and critical-infrastructure customers worldwide. Acquired by Motorola Solutions.
- **TechSee (2018–2019).** Architected and built augmented-reality clients for web, Android, and iOS, running real-time object tracking on live video.
